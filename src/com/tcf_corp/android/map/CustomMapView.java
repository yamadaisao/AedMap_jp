...
public class CustomMapView extends MapView {
    ...
    private final List<TouchListener> mTouchListeners;
    ...
    public CustomMapView(Context context, AttributeSet attribute) {
        ...
        mTouchListeners = new ArrayList<CustomMapView.TouchListener>();
        isTouched = false;
        isDuringAnimation = false;
    }
    ...
    public void notifyZoomChange() {
        ...
        for (ZoomListener listener : mZoomListeners) {
            ...
            listener.onZoomChange(CustomMapView.this, newZoomLevel, mLastZoomLevel);
        }
    ...
    public void notifyCenterChange() {
        ...
        for (PanListener listener : mPanListeners) {
            ...
            listener.onCenterChange(CustomMapView.this, getMapCenter(), new GeoPoint(
                    mLastCenterLati, mLastCenterLongi));
        }
    ...
    public interface PanListener {
        public void onCenterChange(CustomMapView mapView, GeoPoint newGeoPoint, GeoPoint oldGeoPoint);
    }
