...
public class LocationEditBalloonOverlayView extends
		BalloonOverlayView<MarkerItem> {
	...
	public LocationEditBalloonOverlayView(Context context,
	...
	protected void setupView(Context context, final ViewGroup parent) {
		...
		View v = inflater.inflate(R.layout.location_edit_balloon_overlay,
				parent);
